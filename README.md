...
![Version: 1.26.0](https://img.shields.io/badge/Version-1.26.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| istio.git.tag | string | `"1.11.3-bb.2"` |  |
...
| istiooperator.git.tag | string | `"1.11.3-bb.3"` |  |
...
| jaeger.git.tag | string | `"2.27.1-bb.0"` |  |
...
| kiali.git.tag | string | `"1.44.0-bb.3"` |  |
...
| clusterAuditor.git.tag | string | `"1.1.1-bb.0"` |  |
...
| gatekeeper.git.tag | string | `"3.7.0-bb.4"` |  |
...
| kyverno.git.tag | string | `"2.1.3-bb.3"` |  |
...
| logging.git.tag | string | `"0.6.0-bb.1"` |  |
...
| eckoperator.git.tag | string | `"1.9.1-bb.1"` |  |
...
| fluentbit.git.tag | string | `"0.19.16-bb.1"` |  |
...
| tempo.git.tag | string | `"0.12.2-bb.0"` |  |
...
| monitoring.git.tag | string | `"30.0.1-bb.2"` |  |
...
| twistlock.git.tag | string | `"0.2.0-bb.0"` |  |
...
| addons.argocd.git.tag | string | `"3.27.1-bb.4"` |  |
...
| addons.authservice.git.tag | string | `"0.4.0-bb.21"` |  |
...
| addons.minioOperator.git.tag | string | `"4.2.3-bb.4"` |  |
...
| addons.minio.git.tag | string | `"4.2.3-bb.10"` |  |
...
| addons.gitlab.git.tag | string | `"5.6.2-bb.2"` |  |
...
| addons.gitlabRunner.git.tag | string | `"0.34.0-bb.1"` |  |
...
| addons.nexus.git.tag | string | `"36.0.0-bb.3"` |  |
...
| addons.sonarqube.git.tag | string | `"9.6.3-bb.13"` |  |
...
| addons.haproxy | object | `{"flux":{},"git":{"path":"./chart","repo":"https://repo1.dso.mil/platform-one/big-bang/apps/developer-tools/haproxy","tag":"1.1.2-bb.2"},"ingress":{"gateway":""},"postRenderers":[],"values":{}}` | Deployment of HAProxy is automatically toggled depending on Monitoring SSO and Monitoring Istio Injection |
...
| addons.anchore.git.tag | string | `"1.15.0-bb.5"` |  |
...
| addons.mattermostoperator.git.tag | string | `"1.17.0-bb.1"` |  |
...
| addons.velero.git.tag | string | `"2.23.6-bb.4"` |  |
...
| addons.keycloak.git.tag | string | `"16.0.6-bb.0"` |  |
...
| addons.vault.git.tag | string | `"0.18.0-bb.4"` |  |
