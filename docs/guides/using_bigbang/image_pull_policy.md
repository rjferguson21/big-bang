...
| Monitoring | 'Overrides'  | <pre lang="yaml">kube-state-metrics:<br>  image:<br>    pullPolicy:Override <br>grafana:<br>  image:<br>    pullPolicy:Override <br>prometheus-node-exporter:<br>  image:<br>    pullPolicy:Override <br>prometheusOperator:<br>  image:<br>    pullPolicy:Override <br>  admissionWebhooks: <br>   cleanupProxy: <br>    image:<br></pre>|
