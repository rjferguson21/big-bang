...
| Vault | `Always` | <pre lang="yaml">vault:<br>  values:<br>      image:<br>        pullPolicy: IfNotPresent<br>    server:<br>      image:<br>        pullPolicy: IfNotPresent<br>      csi:<br>        imagePullPolicy: IfNotPresent<br> </pre> |
