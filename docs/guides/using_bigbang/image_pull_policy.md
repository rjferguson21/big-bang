...
| Elasticsearch / Kibana | `IfNotPresent` | <pre lang="yaml"> logging:<br>  values:<br>    kibana: <br>      image:<br>        pullPolicy: IfNotPresent<br>    elasticsearch<br>      image:<br>        pullPolicy: IfNotPresent</pre> |
