...
| Vault | `Always` | <pre lang="yaml">vault:<br>  addons:<br>      vault:<br>     injector:<br>        image:<br>        pullPolicy: IfNotPresent<br>    server:<br>      image:<br>        pullPolicy: IfNotPresent<br>      csi:<br>        imagePullPolicy: IfNotPresent<br> </pre> |
